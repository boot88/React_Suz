...
const readChatLocalSettings = (username = 'guest') => {
  try {
    ...
    return { archived: [], hidden: [], pinned: [], muted: [], favorites: [], uiTheme: 'light', uiDensity: 'regular', uiTextSize: 'medium', showChatTemplates: false, showDialogMediaPanel: false, showDialogFilters: false, showDialogDateJump: false, showFeedCategorySelect: false, showFeedFilters: false };
  }
};
